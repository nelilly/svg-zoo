  ...
  return (
    <nav className={helm}>
      <a href="/" className={siteId}>
        <img className={siteLogo} src="/assets/images/svgZooLogo.svg" alt="" />
          ...
          <button className={navigationClose} type="button" aria-expanded={!!open} aria-label="Close navigation menu" onClick={() => setOpen(!open)} ref={navCloseRef}><svg viewBox="0,0 100,100" height="40" width="40" stroke="currentColor" strokeWidth="10" strokeLinecap="round"><path d="M25,25 75,75 M25,75 75,25" fill="none" /></svg></button>
            <section>
              ...
              <ul>
                ...
                <li className={activePage('/')}><Link href={`/`}><a className={navLink} aria-current={routed('/')}>Home</a></Link></li>
                <li className={activePage('/guides')}><Link href={`/guides`}><a className={navLink} aria-current={routed('/guides')}>Guides</a></Link></li>
                <li className={activePage('/tutorials')}><Link href={`/tutorials`}><a className={navLink} aria-current={routed('/tutorials')}>Tutorials</a></Link></li>
                <li className={activePage('/libraries')}><Link href={`/libraries`}><a className={navLink} aria-current={routed('/libraries')}>Libraries</a></Link></li>
                <li className={activePage('/tools')}><Link href={`/tools`}><a className={navLink} aria-current={routed('/tools')}>Tools</a></Link></li>
                {/* <li className={activePage('/examples')}><Link href={`/examples`}><a className={navLink} aria-current={routed('/examples')}>Examples</a></Link></li> */}
                <li className={activePage('/news')}><Link href={`/news`}><a className={navLink} aria-current={routed('/news')}>News</a></Link></li>
              </ul>
            </section>
            <section>
              ...
              <ul>
                {/* <li className={activePage('/about')}><Link href={`/about`}><a className={navLink} aria-current={routed('/about')}>About</a></Link></li> */}
                <li className={activePage('/faqs')}><Link href={`/faqs`}><a className={navLink} aria-current={routed('/faqs')}>FAQs</a></Link></li>
                {/* <li className={activePage('/contact')}><Link href={`/contact`}><a className={navLink} aria-current={routed('/contact')}>Contact</a></Link></li> */}
                {/* <li className={activePage('/announcements')}><Link href={`/announcements`}><a className={navLink} aria-current={routed('/announcements')}>Announcements</a></Link></li> */}
                <li className={activePage('/links')}><Link href={`/links`}><a className={navLink} aria-current={routed('/links')}>Links</a></Link></li>
                <li className={activePage('/colophon')}><Link href={`/colophon`}><a className={navLink} aria-current={routed('/colophon')}>Colophon</a></Link></li>
              </ul>
          </section>
          {/* <section>
